...
class TokenMakerGUI:
    def __init__(self, master):
        ...
        file_name_label = Label(self.master, text="File Name: ")
        ...
        collection_name_label = Label(self.master, text="Collection Name: ")
        ...
        quantity_label = Label(self.master, text="Quantity: ")
        ...
        equivalent_label = Label(self.master, text="Equivalents: ")
        ...
        self.image_file_path = Label(self.master, text=DEFAULT_IMAGE_PATH)
        self.image_file_path.grid(row=0, column=6, rowspan=1, padx=5, pady=5)

        description_label = Label(self.master, text="Description: ")
        ...
        prompt_label = Label(self.master, text="Prompt: ")
