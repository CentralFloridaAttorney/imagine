...
STARTING_IMAGE_PATH = "../../data/dnd/templates/monsters/jackal_attacking.png"
ENHANCED_IMAGE_PATH = STARTING_IMAGE_PATH.replace(".jpg", "_enhanced.png")
ENHANCED_IMAGE_PATH = STARTING_IMAGE_PATH.replace(".png", "_enhanced.png")
...
images = pipe(prompt=jackal_attacking, image=DEFAULT_IMG, strength=.6, guidance_scale=25.5, num_inference_steps=35).images

images[0].save(ENHANCED_IMAGE_PATH)
